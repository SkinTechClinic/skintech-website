    ...
    <div class="container">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:80px; align-items:center;">
        ...
        <div style="border-radius:4px; aspect-ratio:4/5; position:relative; overflow:hidden; background:var(--cream-deep);">
          <img loading="lazy" src="assets/sylton-scan.png" width="940" height="788" alt="Sylton Observ 520x huidscan" style="width:100%; height:100%; object-fit:cover; mix-blend-mode:multiply; filter:brightness(1.05) contrast(1.05) saturate(0.85);"/>
  ...
  <section class="founder-sec">
    <div class="container">
      <div class="founder-grid">
        <div class="founder-photo"><img loading="lazy" src="assets/founder-web.webp" width="1200" height="699" alt="SkinTech clinic"/></div>
